    ...
    public class D_Departamento
    {
        ...
        public DataTable listado()
        {
            ...
            try
            {
                ...
                MySqlCommand command = new MySqlCommand("usp_listar_departamento", mysql);
        ...
        /// <returns></returns>         
        public string guardarActualizar(int opcion, E_Departamento depa)
        {
            string mensaje = "";
            MySqlConnection mysql = new MySqlConnection();
            ...
            {
                mysql = Conexion.getInstancia().crearConexion();
                MySqlCommand command = new MySqlCommand("usp_guardar_departamento", mysql);
                command.CommandType = CommandType.StoredProcedure;
        ...
        public string eliminar(int codigo)
        {
            ...
            {
                mysql = Conexion.getInstancia().crearConexion();
                MySqlCommand command = new MySqlCommand("usp_eliminar_departamento", mysql);
                command.CommandType = CommandType.StoredProcedure;
        ...
        public DataTable listado_Descripcion(string valor)
        {
            ...
            {
                mysql = Conexion.getInstancia().crearConexion();
                MySqlCommand command = new MySqlCommand("usp_listar_departamentoxdescripcion", mysql);
                command.CommandType = CommandType.StoredProcedure;
